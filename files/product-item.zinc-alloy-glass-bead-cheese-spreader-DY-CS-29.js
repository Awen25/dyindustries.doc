var productDetails={
   "productDetails": {
      ...
      "product": {
         "bd": {
            "id": "888200027",
            "img": "/images/products/cheese-spreader/Zinc Alloy Glass Bead Cheese Spreader_DY-CS-29/1.jpg",
            "imgs": [
               {
                  "src": "/images/products/cheese-spreader/Zinc Alloy Glass Bead Cheese Spreader_DY-CS-29/1.jpg",
                  "alt": "Zinc Alloy Glass Bead Cheese Spreader DY-CS-29 1"
               }
            ],
            ...
            "Description": "Colored diamonds Cheese Spreaders set, spreader set with Colored diamonds, beads Butter Spreader Utensils  tools "
         },
         "ft": [
            {
