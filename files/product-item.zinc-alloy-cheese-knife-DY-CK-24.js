var productDetails={
   "productDetails": {
      ...
      "product": {
         "bd": {
            "id": "888100024",
            "img": "/images/products/cheese-knife/Zinc Alloy Cheese Knife_DY-CK-24/1.jpg",
            "imgs": [
               {
                  "src": "/images/products/cheese-knife/Zinc Alloy Cheese Knife_DY-CK-24/1.jpg",
                  "alt": "Zinc Alloy Cheese Knife DY-CK-24 1"
               }
            ],
            ...
            "Description": "4 Pieces Set Cheese Knives with shell decoration Handle Stainless Steel Cheese Slicer Cheese Cutter, set of 4 cheese knife with screw thread handle "
         },
         "ft": [
            {
