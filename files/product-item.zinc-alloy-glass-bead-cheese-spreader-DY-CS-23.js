var productDetails={
   "productDetails": {
      ...
      "product": {
         "bd": {
            "id": "888200023",
            "img": "/images/products/cheese-spreader/Zinc Alloy Glass Bead Cheese Spreader_DY-CS-23/1.jpg",
            "imgs": [
               {
                  "src": "/images/products/cheese-spreader/Zinc Alloy Glass Bead Cheese Spreader_DY-CS-23/1.jpg",
                  "alt": "Zinc Alloy Glass Bead Cheese Spreader DY-CS-23 1"
               }
            ],
            "title": "Zinc Alloy Glass Bead Cheese Spreader",
            "sku": "SKU:DY-CS-23",
            "attar": [
               {
                  "key": "Color",
            ...
            "Description": "Colorful beads Cheese Spreaders set of 2, cheese Fork and spreader set with cross shape handles, Butter Spreader Utensils  tools, Fruit Forks Tasting Appetizer Forks Cocktail Forks for Salad Cake"
         },
         "ft": [
            {
