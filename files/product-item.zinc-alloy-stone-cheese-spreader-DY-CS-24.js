var productDetails={
   "productDetails": {
      ...
      "product": {
         "bd": {
            "id": "888200029",
            "img": "/images/products/cheese-spreader/Zinc Alloy Stone Cheese Spreader_DY-CS-24/1.jpg",
            "imgs": [
               {
                  "src": "/images/products/cheese-spreader/Zinc Alloy Stone Cheese Spreader_DY-CS-24/1.jpg",
                  "alt": "Zinc Alloy Stone Cheese Spreader DY-CS-24 1"
               }
            ],
            "title": "Zinc Alloy Stone Cheese Spreader",
            "sku": "SKU:DY-CS-24",
            "attar": [
               {
                  "key": "Color",
            ...
            "Description": "Colorful stone Cheese Spreaders set of 2 , cheese Fork and spreader set with cross shape handles, Butter Spreader Utensils  tools, Fruit Forks Tasting Appetizer Forks Cocktail Forks for Salad Cake"
         },
         "ft": [
            {
