var productDetails={
   "productDetails": {
      ...
      "product": {
         "bd": {
            "id": "888200018",
            "img": "/images/products/cheese-spreader/Zinc Alloy Cheese Spreader_DY-CS-18/1.jpg",
            "imgs": [
               {
                  "src": "/images/products/cheese-spreader/Zinc Alloy Cheese Spreader_DY-CS-18/1.jpg",
                  "alt": "Zinc Alloy Cheese Spreader DY-CS-18 1"
               }
            ],
            ...
            "Description": "colorfull lobster Cheese Spreaders set of 2, cheese Fork and spreader set with cute handles, Butter Spreader Utensils  tools for bech"
         },
         "ft": [
            {
