var productDetails={
   "productDetails": {
      "breadCrumbs": [
         ...
         {
            "name": "Cheese Spreader",
            "href": "/product-category/cheese-spreader/",
            "isCurrent": false
         },
         {
            "name": "SKU:DY-CS-03",
      ...
      "product": {
         "bd": {
            "id": "88820003",
            "img": "/images/products/cheese-spreader/Zinc Alloy Cheese Spreader_DY-CS-03/1.jpg",
            "imgs": [
               {
                  "src": "/images/products/cheese-spreader/Zinc Alloy Cheese Spreader_DY-CS-03/1.jpg",
                  "alt": "Zinc Alloy Cheese Spreader DY-CS-03 1"
               }
            ],
            "title": "Zinc Alloy Cheese Spreader",
            "sku": "SKU:DY-CS-03",
            "attar": [
               {
                  "key": "Color",
               ...
               {
                  "key": "Size",
                  "value": " 4 3/4\" L4.75 x 3 x 0.5 inches"
               },
               {
                  "key": "Features",
                  "value": "Mermaid decoration"
               },
               {
                  "key": "Sample",
                  "value": "Available"
            ...
            "Description": "Cute Mermaid Cheese Spreaders Set of 4,   Metal Cheese Spreaders Kitchen Set of 2 with uinique Mermaid decoration  ,Butter Spreader Utensils For beach party or  nautical utensil in table setup <br/> The appetizer spreaders are decorated utensils with unique handles featuring a mermaid with legendary details of a fantasy sea creature. A woman with beautiful long hair & a shimmering scaly tail of a fish. "
         },
         "ft": [
            {
