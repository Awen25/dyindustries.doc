var productDetails={
   "productDetails": {
      ...
      "product": {
         "bd": {
            "id": "88880004",
            "img": "/images/products/wood-cheese-board/cheese board _DY-CB-04/1.jpg",
            "imgs": [
               {
                  "src": "/images/products/wood-cheese-board/cheese board _DY-CB-04/1.jpg",
                  "alt": "cheese board  DY-CB-04 1"
               },
               {
                  "src": "/images/products/wood-cheese-board/cheese board _DY-CB-04/2.jpg",
                  "alt": "cheese board  DY-CB-04 2"
               }
            ],
            "title": "cheese board ",
            "sku": "SKU:DY-CB-04",
            "attar": [
               ...
               {
                  "key": "Size",
                  "value": "30*16.5*.1.5cm  ( 11.8*6.5*0.6\")"
               },
               {
                  "key": "Features",
                  "value": ""
            ...
            "Description": "Snowflake Serving Board , multifunction Acacia Wood Cheese Plate , Perfect Cheese Platter Slate Board Cheese Serving Board for chrismas <br/><br/>Modern and Contemporary Style Serving Board, Use as Cheese Board or Bread Board, functional design accented with zinc alloy Snowflake decoration <br/><br/>The perfect acacia wood centerpiece board to hold your cheeses, cured meats, olives, dried fruits, nuts and crackers,Also great for smaller pizzas and flatbreads or your other favorite appetizers <br/><br/>Handcrafted from sustainably harvested gorgeous acacia wood, known for its unique and natural contrasting patterns and antibacterial properties.Durable and Tested for Food Service and Restaurants (Clean by Hand, not Dishwasher)<br/><br/>Perfect Gift Idea --- The board is made with real acacia wood, high quality, no-mildew again. It is attractive and practical present for your parents, neighbors, weddings, Thanksgiving, Christmas, housewarmings, birthdays, mother's day, father's day , summer holiday or other special days"
         },
         "ft": [
            {
