var productDetails={
   "productDetails": {
      ...
      "product": {
         "bd": {
            "id": "888200025",
            "img": "/images/products/cheese-spreader/Zinc Alloy Glass Bead Cheese Spreader_DY-CS-27/1.jpg",
            "imgs": [
               {
                  "src": "/images/products/cheese-spreader/Zinc Alloy Glass Bead Cheese Spreader_DY-CS-27/1.jpg",
                  "alt": "Zinc Alloy Glass Bead Cheese Spreader DY-CS-27 1"
               }
            ],
            ...
            "Description": "Fish Cheese Spreaders set of 2, cheese Fork and spreader set with Fish shape handles, beads Butter Spreader Utensils tools "
         },
         "ft": [
            {
