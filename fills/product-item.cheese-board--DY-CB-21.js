var productDetails={
   "productDetails": {
      ...
      "product": {
         "bd": {
            "id": "888800021",
            "img": "/images/products/wood-cheese-board/cheese board _DY-CB-21/1.jpg",
            "imgs": [
               {
                  "src": "/images/products/wood-cheese-board/cheese board _DY-CB-21/1.jpg",
                  "alt": "cheese board  DY-CB-21 1"
               },
               {
                  "src": "/images/products/wood-cheese-board/cheese board _DY-CB-21/2.jpg",
                  "alt": "cheese board  DY-CB-21 2"
               }
            ],
            "title": "cheese board ",
            "sku": "SKU:DY-CB-21",
            "attar": [
               ...
               {
                  "key": "Size",
                  "value": "Round : 38*29*1.5 /33*25*1.5/28*19.5*1.5 CM    Long: 43*24.5*1.6/ 38*20*1.6 CM"
               },
               {
                  "key": "Features",
                  "value": ""
            ...
            "Description": "Circle arrow design Serving Board , multifunction Acacia Wood Cheese Plate , Perfect Cheese Platter Slate Board Cheese Serving Board <br/><br/>Modern and Contemporary Style Serving Board, Use as Cheese Board or Bread Board, functional design accented with mult-color arrow decoration <br/><br/>The perfect acacia wood centerpiece board to hold your cheeses, cured meats, olives, dried fruits, nuts and crackers,Also great for smaller pizzas and flatbreads or your other favorite appetizers <br/><br/>Handcrafted from sustainably harvested gorgeous acacia wood, known for its unique and natural contrasting patterns and antibacterial properties.Durable and Tested for Food Service and Restaurants (Clean by Hand, not Dishwasher)<br/><br/>Perfect Gift Idea --- The board is made with real acacia wood, high quality, no-mildew again. It is attractive and practical present for your parents, neighbors, weddings, Thanksgiving, Christmas, housewarmings, birthdays, mother's day, father's day , summer holiday or other special days"
         },
         "ft": [
            {
