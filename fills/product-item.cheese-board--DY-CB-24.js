var productDetails={
   "productDetails": {
      ...
      "product": {
         "bd": {
            "id": "888800024",
            "img": "/images/products/wood-cheese-board/cheese board _DY-CB-24/1.jpg",
            "imgs": [
               {
                  "src": "/images/products/wood-cheese-board/cheese board _DY-CB-24/1.jpg",
                  "alt": "cheese board  DY-CB-24 1"
               }
            ],
            "title": "cheese board ",
            "sku": "SKU:DY-CB-24",
            "attar": [
               ...
               {
                  "key": "Size",
                  "value": "58*17.5*2CM  (22.8*6.9*0.8\")   38.5*12*1.6cm (15\"*4.7*0.6\")"
               },
               {
                  "key": "Features",
                  "value": ""
            ...
            "Description": "Wooden Cutting Board set of 2  / appetizers Serving Board with two handles ,Perfect cheese board for chitchen ,home decoration <br/><br/>Modern and Contemporary Style Serving Board, Use as Cheese Board or Bread Board, functional design accented with   cooking printing decoration <br/><br/>Ceative cheese board with two handles design , More convenient and  better grip than others board <br/><br/>The perfect acacia wood centerpiece board to hold your cheeses, cured meats, olives, dried fruits, nuts and crackers,Also great for smaller pizzas and flatbreads or your other favorite appetizers <br/><br/>Handcrafted from sustainably harvested gorgeous acacia wood, known for its unique and natural contrasting patterns and antibacterial properties.Durable and Tested for Food Service and Restaurants (Clean by Hand, not Dishwasher)<br/><br/>Perfect Gift Idea --- The board is made with real acacia wood, high quality, no-mildew again. It is attractive and practical present for your parents, neighbors, weddings, Thanksgiving, Christmas, housewarmings, birthdays, mother's day, father's day , summer holiday or other special days"
         },
         "ft": [
            {
