var productDetails={
   "productDetails": {
      ...
      "product": {
         "bd": {
            "id": "888200028",
            "img": "/images/products/cheese-spreader/Zinc Alloy Metal Cheese Spreader_DY-CS-25/1.jpg",
            "imgs": [
               {
                  "src": "/images/products/cheese-spreader/Zinc Alloy Metal Cheese Spreader_DY-CS-25/1.jpg",
                  "alt": "Zinc Alloy Metal Cheese Spreader DY-CS-25 1"
               }
            ],
            "title": "Zinc Alloy Metal Cheese Spreader",
            "sku": "SKU:DY-CS-25",
            "attar": [
               {
                  "key": "Color",
            ...
            "Description": "Bells Cheese Spreaders set of 2, cheese Fork and spreader set with colorfull bells handles, Butter Spreader Utensils tools for Christmas holiday"
         },
         "ft": [
            {
