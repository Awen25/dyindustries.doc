   ...
   "productDetails": {
      ...
      "product": {
         "bd": {
            ...
            "Description": " Rustic Metal Wire & Wood Nesting Serving Trays with Handles , monogramed S serving board with metal base <br/><br/>Decorative metal wire and wood nesting serving trays perfect for storage and for serving food and drinks to guests<br/><br/>Nesting design allows baskets to be easily put into storage when not in use<br/><br/>Side handles allow for easy transportation from room to room<br/>Metal wire and wood aesthetic complements rustic decors<br/><br/>Rectangle Serving Tray with Handles Home and Kitchen Multi-Purpose Serveware for Coffee Table, Dinner, Breakfast, Food, Farmhouse Decor, 14*10*1.5\" Wood"
         },
         "ft": [
            {
